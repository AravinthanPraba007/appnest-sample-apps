...
3. In `06-technical-architecture.md`, ensure:
   ...
   - All I/O uses AppNest SDK ($db, $fetch, $file, $next, $schedule); no axios/fetch; no adding SDK to backend package.json; no react/react-dom in frontend package.json.
