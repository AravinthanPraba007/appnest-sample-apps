...
| 4.3 | All external HTTP uses **$fetch** (no axios/fetch). All persistent state uses **$db**. Long-running/chained work uses **$schedule** or **$next**. | Yes | ☐ Pass ☐ Fail ☐ Unclear | 06 + 09; ref. SDK usage rules. |
