...
- Add **`@sparrowengg/twigs-react`** and **`@sparrowengg/twigs-react-icons`** to `app-frontend/package.json` before implementing any UI. Do not skip this step or assume the packages are private—they are required dependencies.
