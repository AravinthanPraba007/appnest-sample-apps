...
| **Entry points** | 06-technical-architecture and validation checklist enforce server.js + App.jsx, invoke({ functionName, payload }). |
...
- **Change:** Generation workflow Step 2 updated so filling the template includes file storage, scheduled jobs, and $next usage when applicable.
