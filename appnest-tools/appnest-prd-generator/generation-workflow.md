...
2. Replace every placeholder with the corresponding answer:
   ...
   - If the app has a **full-page UI**: fill **11-ui-screens.md** (screens overview, and for each screen: purpose, entry, layout, actions with functionName, data shown, empty/loading/error). Optionally set **Screen(s)** in 04-user-flows for each flow.
